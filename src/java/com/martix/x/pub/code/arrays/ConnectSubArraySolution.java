 ...
 * 输出：true
 * 解释：你可以分别在 nums 中选出第 0 个子数组 [1,-1,0,1,-1,-1,3,-2,0] 中的(1,-1,-1) 和第 1 个子数组 [1,-1,0,1,-1,-1,3,-2,0] 中的（3,-2,0） 。
 * 这两个子数组是不相交的，因为它们没有任何共同的元素。
 * 示例 2：
 *
 * 输入：groups = [[10,-2],[1,2,3,4]], nums = [1,2,3,4,10,-2]
 * 输出：false
 * 解释：选择子数组 [1,2,3,4,10,-2] 中的（1,2,3,4）和 [1,2,3,4,10,-2] 中的（10,-2）是不正确的，因为它们出现的顺序与 groups 中顺序不同。
 * [10,-2] 必须出现在 [1,2,3,4] 之前。
 * 示例 3：
 *
 * 输入：groups = [[1,2,3],[3,4]], nums = [7,7,1,2,3,4,7,7]
 * 输出：false
 * 解释：选择子数组 [7,7,1,2,3,4,7,7] 中的（1,2,3） 和 [7,7,1,2,3,4,7,7]中的(3,4) 是不正确的，因为它们不是不相交子数组。
